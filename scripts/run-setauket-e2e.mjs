/**
 * run-setauket-e2e.mjs
 *
 * Full end-to-end pipeline test for 25W050 Setauket Avenue, Naperville, IL (DuPage County).
 ...
 *
 * Usage:
 *   SUPABASE_SERVICE_ROLE_KEY=<key> node scripts/run-setauket-e2e.mjs
 *
 * Requires:
...
async function main() {
  if (!SERVICE_ROLE_KEY) {
    ...
    err('  SUPABASE_SERVICE_ROLE_KEY=<key> node scripts/run-setauket-e2e.mjs');
    process.exit(1);
  }
  ...
  console.log('\n═══════════════════════════════════════════════════════════════');
  console.log('  E2E PIPELINE TEST — 25W050 Setauket Avenue, Naperville IL (DuPage)');
  ...
  console.log('\n═══════════════════════════════════════════════════════════════');
  console.log('  RESULTS — 25W050 Setauket Avenue, Naperville IL');
  console.log('═══════════════════════════════════════════════════════════════');
