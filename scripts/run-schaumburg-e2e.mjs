/**
 * run-schaumburg-e2e.mjs
 * One-off founder E2E for 1105 Remington Road, Schaumburg, IL (Cook 17031).
...
const REPORT_PAYLOAD = {
  ...
  client_name: 'Jordan (Schaumburg E2E)',
  ...
  photos_skipped: true,
  property_issues: [],
  additional_notes: 'Founder E2E � Schaumburg Cook County pipeline test',
...
const STAGE_LABELS = {
  ...
  'stage-6-filing':     'Stage 6 � Filing Guide',
...
console.log('\n---------------------------------------------------------------');
console.log('  E2E � 1105 Remington Road, Schaumburg, IL (Cook County)');
console.log('  Provider: Claude only (Opus 4.7 + Haiku 4.5)');
console.log('---------------------------------------------------------------\n');
...
try {
  ...
  log(`Live preview: ${BASE_URL}/report/${reportId}`);
} catch (err) {
