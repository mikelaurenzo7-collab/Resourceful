...
3. Guides or automates filing and follow-up.
4. Learns from outcomes across counties to improve future results.
...
The existing tiers can be reframed without changing core mechanics:

- Auto Report -> **Starter Intelligence**
- Expert Reviewed -> **Operator Mode**
- Guided Filing -> **Execution Assist**
- Full Representation -> **Autopilot Appeal**

The existing three service types can also be repositioned:

- Tax Appeal Report -> **Tax Reduction Engine**
- Pre-Purchase Analysis -> **Acquisition Intelligence**
- Pre-Listing Analysis -> **Seller Strategy Intelligence**

## Why This Justifies the Subscription
...
## Practical Scope for This Pass

For this iteration, prioritize high-visibility changes:
