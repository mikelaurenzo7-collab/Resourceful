...
const SERVICE_OPTIONS: {
...
}[] = [
  {
    ...
    description:
      'Claude analyzes your assessment, builds the comparable set, and prepares the evidence package needed to pursue a reduction.',
    icon: (
  ...
  },
  {
    ...
    description:
      "Before you buy, Claude tests price, taxes, and downside risk so you know whether the deal is actually worth pursuing.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      "Before you list, Claude sharpens your pricing story and gives buyers a clearer view of the tax burden attached to the property.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      <div className="text-center mb-10 animate-fade-in">
        ...
        <h1 className="font-display text-3xl md:text-4xl text-cream mb-3">
          What should Claude run?
        </h1>
        <p className="text-cream/50 max-w-lg mx-auto">
          Select the workflow you want Claude to operate and we&apos;ll tailor the system to your property, county, and objective.
        </p>
      </div>
      ...
      {state.serviceType === 'tax_appeal' && (
        <div className="mt-8 animate-fade-in">
          <label className="block text-sm text-cream/60 mb-2">
            Tell Claude about your situation <span className="text-cream/30">(optional)</span>
          </label>
          <textarea
          ...
          />
          <p className="text-xs text-cream/25 mt-1.5">This helps Claude prioritize the case and identify the strongest angle for action.</p>
        </div>
      )}
