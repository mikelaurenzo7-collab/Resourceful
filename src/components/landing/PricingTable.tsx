...
const tiers = [
  {
    ...
    tier: 'auto' as const,
    description: 'The essential AI workflow: evidence built by Claude Sonnet, prioritized insights, and a clean customer-ready package.',
    features: [
  ...
  },
  {
    ...
    description: 'Everything in Starter Intelligence, plus human review layered on top of the AI operating system.',
    features: [
  ...
  },
  {
    ...
    description: 'Operator Mode plus live execution support so the AI does the heavy lifting and your customer never feels alone.',
    features: [
  ...
  },
  {
    ...
    description: 'The highest-leverage tier: AI runs the workflow while the team handles filing and representation.',
    features: [
    ...
    <section className="mx-auto max-w-6xl px-6 py-24" id="pricing">
      <div className="text-center mb-14">
        ...
        <p className="mt-4 text-cream/40 max-w-xl mx-auto leading-relaxed">
          Every tier uses the same operating system. What changes is how much of the workflow the AI and the team take off the customer’s plate.
        </p>
      </div>
