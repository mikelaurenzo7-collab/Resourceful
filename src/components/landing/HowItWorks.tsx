const steps = [
  ...
  },
  {
    ...
    description:
      'We pull 5\u201310 comparable sales from public records, calculate line-item adjustments for size, age, and condition, and compare your assessment ratio against county standards. Most reports are delivered within 48 hours.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
