const steps = [
  {
    ...
    description:
      'Enter the address, choose the workflow, and add the context that matters. Uploading a tax bill lowers the price and gives the valuation engine cleaner source data.',
    icon: (
  ...
  },
  {
    ...
    description:
        'GPT-5.6 Sol evaluates comparables, assessment records, owner-provided documents, condition evidence, and available jurisdiction rules to draft the strongest supportable case.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      'The output is not just a report. It is a reviewable action package with valuation evidence, property intelligence, filing guidance, and the next operational step already framed.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <section className="mx-auto max-w-6xl px-6 py-24">
      <div className="text-center mb-14">
        ...
        <h2 className="font-display text-3xl md:text-4xl text-cream mt-3 tracking-tight">
          Three Steps to a Stronger Appeal Path
        </h2>
      </div>
