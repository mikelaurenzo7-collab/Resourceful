...
export function OrganizationJsonLd() {
  const schema = {
    ...
    description:
      'An AI-led property tax reduction company. Claude runs comparable analysis, case assembly, and filing support for property owners nationwide.',
    foundingDate: '2025',
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          priceCurrency: 'USD',
          description:
            'High-leverage appeal service where Claude runs the workflow and the team handles filing, representation, and full-process management.',
