    ...
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-navy-deep/90 backdrop-blur-xl border-b border-cream/[0.04]">
        <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-5">
            <Link
              href="/login"
              className="text-sm text-cream/50 hover:text-cream transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:ring-offset-2 focus:ring-offset-navy-deep rounded-md px-3 py-1.5"
            >
              Sign In
            </Link>
            <Link
      ...
      <section className="relative border-y border-cream/[0.04]" data-animate>
        ...
        <div className="mx-auto max-w-5xl px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 relative">
          <div className="flex items-center gap-3.5" data-animate data-delay="100">
            <div className="w-11 h-11 rounded-xl bg-red-500/[0.08] flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-red-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex items-center gap-3.5" data-animate data-delay="250">
            <div className="w-11 h-11 rounded-xl bg-gold/[0.08] flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-3.5" data-animate data-delay="400">
            <div className="w-11 h-11 rounded-xl bg-emerald-500/[0.08] flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-emerald-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center" data-animate data-delay={String(i * 100)}>
                <div className="w-11 h-11 rounded-xl bg-gold/[0.06] border border-gold/[0.08] flex items-center justify-center mx-auto mb-3">
                  <svg className="w-5 h-5 text-gold/60" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20" data-animate>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="card-premium rounded-xl p-8 text-center" data-animate data-delay="100">
            <div className="w-12 h-12 rounded-xl bg-emerald-500/[0.08] flex items-center justify-center mx-auto mb-5">
              <svg className="w-6 h-6 text-emerald-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="card-premium rounded-xl p-8 text-center" data-animate data-delay="200">
            <div className="w-12 h-12 rounded-xl bg-gold/[0.08] flex items-center justify-center mx-auto mb-5">
              <svg className="w-6 h-6 text-gold/70" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="card-premium rounded-xl p-8 text-center" data-animate data-delay="300">
            <div className="w-12 h-12 rounded-xl bg-blue-500/[0.08] flex items-center justify-center mx-auto mb-5">
              <svg className="w-6 h-6 text-blue-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="mx-auto max-w-6xl px-6 py-24" data-animate>
        <div className="relative card-elevated rounded-2xl p-12 md:p-16 text-center overflow-hidden">
          {/* Background glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[250px] bg-gold/[0.03] rounded-full blur-[100px] pointer-events-none" />

          <h2 className="relative font-display text-3xl md:text-4xl text-cream leading-tight tracking-tight">
          ...
          <Link
            href="/start"
            className="relative mt-10 inline-flex items-center gap-3 rounded-xl bg-gradient-to-r from-gold-light via-gold to-gold-dark px-9 py-4 text-base font-semibold text-navy-deep shadow-gold hover:shadow-gold-lg transition-all duration-300 hover:scale-[1.02] hover:brightness-110 btn-glow"
          >
            Run the Numbers
