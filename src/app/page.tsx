...
export const metadata = buildMetadata({
  ...
  description: 'An AI-powered property tax reduction platform. Claude Sonnet and Gemini run valuation research, case assembly, filing support, and workflow intelligence so property owners move faster and save more.',
});
        ...
        <div className="mx-auto max-w-5xl px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 relative">
          <div className="flex items-center gap-3.5" data-animate data-delay="100">
            ...
            <div>
              ...
              <p className="text-[11px] text-cream/40 leading-tight">AI keeps the pipeline moving without adding headcount</p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20" data-animate>
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="card-premium rounded-xl p-8 text-center group" data-animate data-delay="200">
            ...
            <p className="text-sm text-cream/40 leading-relaxed">
              The platform can only run the business if trust is durable. Photos, tax bills, and personal information stay protected with strong security controls and customer-controlled deletion.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24" data-animate>
        <div className="relative card-elevated rounded-2xl p-12 md:p-16 text-center overflow-hidden">
          ...
          <p className="relative mt-3 text-sm text-gold/60 font-medium">
            Upload a tax bill and save 15% while giving the AI better source data to work from.
          </p>
          <Link
            href="/start"
