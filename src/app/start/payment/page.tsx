    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-cream font-medium">
                {state.reviewTier === 'expert_reviewed'
                  ? 'Expert-Reviewed (AI + Professional Appraiser)'
                  : 'AI-Powered Analysis'}
              </p>
        ...
        <p className="text-center text-xs text-cream/25 leading-relaxed">
          {state.reviewTier === 'expert_reviewed'
            ? 'Your report will be generated by our advanced AI system, then personally reviewed by a licensed appraiser before delivery within 1-2 business days.'
            : 'Your report will be generated and delivered to your email within minutes, powered by our advanced AI valuation system.'}
        ...
        <div className="space-y-6 animate-slide-up">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <h3 className="font-display text-lg text-cream mb-1">AI-Powered Report</h3>
              <p className="text-sm text-cream/40 mb-3">
                Our advanced, professionally trained AI valuation system analyzes your property against real market data, comparable sales, and county records.
              </p>
              <ul className="text-xs text-cream/50 space-y-1.5 mb-4">
                <li className="flex items-start gap-2">
                  ...
                  Advanced AI trained on real appraisal standards
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 text-gold/60 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            ...
            >
              ...
              <p className="text-sm text-cream/40 mb-3">
                Everything in the AI report, plus a hands-on review by a licensed professional appraiser who verifies accuracy and strengthens your case.
              </p>
              <ul className="text-xs text-cream/50 space-y-1.5 mb-4">
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 text-gold/60 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                  Everything in the AI-Powered Report
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 text-gold/60 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
