      ...
      <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-cream font-medium">
                {state.reviewTier === 'guided_filing'
                  ? 'Guided Filing (Report + Live Coaching)'
                  : state.reviewTier === 'expert_reviewed'
                    ? 'Expert-Reviewed (We File For You)'
                    : 'Pro Se Filing (You File Yourself)'}
              </p>
        ...
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-sm font-medium text-emerald-400">Money-Back Guarantee</span>
              <span className="text-xs text-cream/40 ml-2">No savings found? Full refund.</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 animate-slide-up">
          ...
          <div className={`grid grid-cols-1 ${isTaxAppeal ? 'sm:grid-cols-2' : 'sm:grid-cols-2'} gap-4`}>
            ...
            >
              ...
              <h3 className="font-display text-lg text-cream mb-1">Pro Se Filing</h3>
              <p className="text-sm text-cream/40 mb-3">
                Professional report with comparable sales analysis, condition documentation, and county-specific pro se filing instructions. You file the appeal yourself.
              </p>
            ...
            >
              ...
              <p className="text-sm text-cream/40 mb-3">
                Everything in the Pro Se report, plus expert review by a licensed appraiser. We file the appeal and attend the hearing on your behalf.
              </p>
              <ul className="text-xs text-cream/50 space-y-1.5 mb-4">
                <li className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 text-gold/60 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              {isTaxAppeal && <p className="text-[10px] text-cream/25 mt-1">Available where authorized representatives are permitted</p>}
            </button>
