                ...
                {state.reviewTier === 'full_representation'
                  ...
                  : state.reviewTier === 'guided_filing'
                    ...
                    : state.reviewTier === 'expert_reviewed'
                      ...
                      : 'Delivered to your email same day'}
              </p>
            </div>
          ...
          {state.reviewTier === 'full_representation'
            ...
            : state.reviewTier === 'guided_filing'
              ...
              : state.reviewTier === 'expert_reviewed'
                ...
                : 'Your report will be generated and delivered to your email same day, powered by our advanced valuation system.'}
        ...
        <div className="space-y-6 animate-slide-up">
          ...
          <div className={`grid grid-cols-1 ${isTaxAppeal ? 'sm:grid-cols-2' : 'sm:grid-cols-2'} gap-4`}>
            ...
            >
              ...
              <h3 className="font-display text-lg text-cream mb-1">Standard Report</h3>
          ...
          <div className="flex gap-4">
            ...
            <Button size="lg" fullWidth loading={creating} disabled={creating} onClick={handleCreateReport}>
