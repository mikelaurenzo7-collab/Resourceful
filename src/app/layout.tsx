...
export const metadata: Metadata = {
  ...
  description:
    "An AI-powered property tax reduction platform. Claude Sonnet and Gemini run valuation research, case assembly, filing support, and workflow intelligence so property owners move faster and save more.",
  keywords: [
    "ai property tax",
    "property tax appeal",
  ...
  openGraph: {
    ...
    description:
      "An AI-powered property tax reduction platform. Claude Sonnet and Gemini run valuation research, comparable analysis, and filing support for property owners nationwide.",
    type: "website",
  ...
  twitter: {
    ...
    title: "REsourceful | The AI Property Tax Operator",
    description:
      "AI-powered property tax research, case assembly, and filing support so property owners move faster and save more.",
