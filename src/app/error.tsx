...
export default function GlobalError({
  ...
  return (
    <div className="min-h-screen bg-pattern flex items-center justify-center px-6" role="alert">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display text-2xl text-cream mb-3">Something went wrong</h1>
