  ...
  return (
    <div className="min-h-screen bg-pattern flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        {/* Form */}
        {resetMode ? (
          <form onSubmit={handleResetPassword} className="card-premium rounded-xl p-8 space-y-6">
            {error && (
            ...
            {resetSent ? (
              <div className="rounded-lg bg-green-900/20 border border-green-500/20 p-4 text-sm text-green-400">
              ...
              <>
                ...
                <div>
                  <label htmlFor="reset-email" className="block text-sm font-medium text-cream/80 mb-2">
                    Email Address
                  </label>
                  <input
                    id="reset-email"
            ...
            <button
              ...
              className="w-full text-center text-sm text-gold hover:text-gold-light transition-colors font-medium"
            >
              Back to sign in
            </button>
          </form>
