...
export interface NarrativePayload {
  ...
  overvaluationAnalysis?: {
    ...
    assessedExceedsMarket: boolean; // true if assessed > our concluded market value
...
${payload.overvaluationAnalysis.assessedExceedsMarket ? `- INDEPENDENT CONFIRMATION: Assessed value EXCEEDS our independently concluded market value — comparable sales analysis cannot justify this assessment level` : ''}
