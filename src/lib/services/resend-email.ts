    ...
    const { data, error } = await getResend().emails.send({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="${params.pdfUrl}" style="display: inline-block; background: #2563eb; color: #fff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600;">
          ...
          <p style="margin-top: 32px; font-size: 12px; color: #999;">
            This report was generated by Resourceful. If you have questions, reply to this email.
          </p>
        </div>
      `,
    });
