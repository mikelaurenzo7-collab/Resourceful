      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="margin-top: 32px; font-size: 12px; color: #999;">
            This report was generated by Resourceful. Reports are AI-generated informational tools, not legal advice or formal appraisals. You are responsible for verifying all data and meeting filing deadlines.
          </p>
        </div>
      `,
    });
